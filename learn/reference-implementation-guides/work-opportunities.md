...
5. BAP sends the customer details to the BPP in on\_init. This is the initializing step of the job application process.
...
6. BPP sends the on\_init response with an optional input form to collect additional details (feature to be added).
