...
Open Network Telemetry SDK is a javascript SDK which takes beckn request message and context object and generates the telemetry.

Please refer to the [readme](https://github.com/Sunbird-Obsrv/open-network-telemetry) for more details.

### Using the API

Use the following API to send Telemetry to ONEST Obsrv.
