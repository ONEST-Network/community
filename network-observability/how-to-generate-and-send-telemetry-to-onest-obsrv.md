...
We enhanced the Protocol Server to emit telemetry and send to ONEST Obsrv. Use this[ GitHub Repo](https://github.com/ONEST-Network/protocol-server) to get the updated protocol server code and use it. \
\
Backup the logs generated by protocol server till now before doing a deployment. Extract the API data from the backed up logs and ingest [#using-the-api-without-protocol-server](how-to-generate-and-send-telemetry-to-onest-obsrv.md#using-the-api-without-protocol-server "mention").\
\
